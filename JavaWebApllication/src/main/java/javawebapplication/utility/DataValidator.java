...
public class DataValidator {
	...
	// Validate the name or any text input filed for a single string
	...
	// Validate the full name or any text input filed for a complex string
	public static boolean isFullName(String val) {
		    String name = "^[a-zA-Zà-úÀ-Ú ]*$";
		    if (val.matches(name)) {
		      return true;
		    } else {
		      return false;
